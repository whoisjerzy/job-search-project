  ...
  return (
    <div className="footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-start justify-center">
      <div>
        ...
        <p className="text-white pb-[13px] opacity-70 leading-7">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores ex ab ducimus maiores deleniti corrupti tempor.</p>
      </div>
      <div className="grid">
      ...
      <div className="grid">
        ...
        <div>
          <small className=" text-[14px] text-white">tsirosgeorge@icloud.com</small>
          <div className="icons flex gap-4 py-[1rem]">
            <AiFillLinkedin className="bg-white p-[8px] h-[35px] w-[35px] rounded-full icon text-blueColor" />
            <AiFillTwitterSquare className="bg-white p-[8px] h-[35px] w-[35px] rounded-full icon text-blueColor" />
          </div>
        </div>
      </div>
    </div>
